...
import { UpdateAdmission, FindOneAddmission } from "../../../Service/admin/collage";
import { Image_url } from '../../../config/config';


export default function EditAddmission() {
    ...
    const formik = useFormik({
        ...
        initialValues: {
            ...
            studentName: addmission.studentName || "",
            fatherName: addmission.fatherName || "",
            motherName: addmission.motherName || "",
            gender: addmission.gender || "",
            DOB: addmission.DOB || "",
            mobile: addmission.mobile || "",
            email: addmission.email || "",
            aadhaar: addmission.aadhaar || "",
            address: addmission.address || "",
            courseName: addmission.className || "",
            session: addmission.session || "",
            admissionDate: addmission.admissionDate || "",
            qualification: addmission.qualification || "",
            board: addmission.board || "",
            passingYear: addmission.passingYear || "",

            percentage: addmission.percentage || "",
            photo: addmission.photo || "",
            signature: addmission.signature || "",
